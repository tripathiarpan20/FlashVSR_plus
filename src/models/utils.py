...
class Buffer_LQ4x_Proj(nn.Module):
    """
    Original v1.0 projection module with buffer-style cache management.
    Cache is updated AFTER convolution operation.
    """
...
class Causal_LQ4x_Proj(nn.Module):
    """
    v1.1 projection module with causal-style cache management.
    Cache is updated BEFORE being used in next convolution (improved temporal stability).
    """
